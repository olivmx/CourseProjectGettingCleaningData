...
codebook.md:
================================
Contains small descritpion of all transformations performed to the data

README.md:
================================
This file to list all components 


run_analysis.R
================================
The actual script to process the information



AveragesByActivity.txt
================================
Result of the project as a text file.
